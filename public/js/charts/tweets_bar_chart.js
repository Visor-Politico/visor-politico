...
Highcharts.chart('tweets_bar_chart', {
    ...
    tooltip: {
        ...
        pointFormatter: function() {
            ...
            return '<span style="font-size:11px; color:'+this.color+'">'+this.name.capitalize()+','+ jsonData[this.name]["data"].actor_politico+': </span> <br> <b>'+thousandsSep(this.y)+'</b> tweets '+tw+'<br/>'; },
        borderRadius: 5,
        hideDelay: 0
    },
    series: [{
